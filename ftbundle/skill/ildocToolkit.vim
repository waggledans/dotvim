" IldocToolkit.vim
" Brief: Usefull tools for Ildoc (comment, author, license).
" Version: 0.2.13
" Date: 2010/10/16
...
" 	 - Insert position is correct when g:IldocToolkit_compactOneLineDoc = "yes"
" 	   and let g:IldocToolkit_commentType = "C++" are set.
" 	 - When you define:
" 	 		g:IldocToolkit_briefTag_pre = "@brief "
" 	 		g:IldocToolkit_briefTag_post = "<++>"
" 	 		g:IldocToolkit_briefTag_funcName = "yes"
...
"   - New option are available: g:IldocToolkit_throwTag_pre and
"     g:IldocToolkit_throwTag_post
"
" Note: Add support for documentation of template parameters.
"       Thanks to Dennis (plasmahh) and its suggestions.
"   - New option are available: g:IldocToolkit_templateParamTag_pre
"     and g:IldocToolkit_templateParamTag_post
"
"
" Note: Bug correction (thanks to Jhon Do)
"   - IldocToolkit_briefTag_funcName and other xxx_xxName parameters 
...
"
" Note: Added @version tag into the DocBlock generated by IldocAuthorFunc()
"       (thanks to Dave Walter).
"       The version string can be defines into your .vimrc file with 
"       g:IldocToolkit_versionString or it will be asked the first time the
...
"     g:IldocToolkit_compactOneLineDoc to "yes").
"
...
"     parameters g:IldocToolkit_blockHeader and
"     g:IldocToolkit_blockFooter) do not integrate header and footer
"     anymore.
...
"   - New option available for cinoptions : g:IldocToolkit_cinoptions
...
"   - You can define 'let g:IldocToolkit_briefTag_funcName = "yes"' to add
...
"     ...
"     #endif
"   You only have to execute the command :IldocUndoc(DEBUG) !
"   
" - Group :
"   In vim, execute the command :IldocBlock to insert a doxygen block on the
"   following line.
"
" Limitations:
...
"
"
" To customize the output of the script, see the g:IldocToolkit_*
" variables in the script's source.  These variables can be set in your
" .vimrc.
"
" For example, my .vimrc contains:
" let g:IldocToolkit_briefTag_pre="@Synopsis  "
" let g:IldocToolkit_paramTag_pre="@Param "
" let g:IldocToolkit_returnTag="@Returns   "
" let g:IldocToolkit_blockHeader="--------------------------------------------------------------------------"
" let g:IldocToolkit_blockFooter="----------------------------------------------------------------------------"
" let g:IldocToolkit_authorName="Dan Slov"
" let g:IldocToolkit_licenseTag="My own license"   <-- Does not end with
" "\<enter>"


" Verify if already loaded
"if exists("loaded_IldocToolkit")
" echo 'IldocToolkit Already Loaded.'
" finish
"endif
let loaded_IldocToolkit = 1
"echo 'Loading IldocToolkit...'
...
if !exists("g:IldocToolkit_briefTag_pre")
  let g:IldocToolkit_briefTag_pre = "@brief "
endif
if !exists("g:IldocToolkit_briefTag_post")
  let g:IldocToolkit_briefTag_post = ""
endif
if !exists("g:IldocToolkit_templateParamTag_pre")
  let g:IldocToolkit_templateParamTag_pre = "@tparam "
endif
if !exists("g:IldocToolkit_templateParamTag_post")
  let g:IldocToolkit_templateParamTag_post = ""
endif
if !exists("g:IldocToolkit_paramTag_pre")
  let g:IldocToolkit_paramTag_pre = "@param "
endif
if !exists("g:IldocToolkit_paramTag_post")
  let g:IldocToolkit_paramTag_post = ""
endif
if !exists("g:IldocToolkit_returnTag")
  let g:IldocToolkit_returnTag = "@return "
endif
if !exists("g:IldocToolkit_throwTag_pre")
  let g:IldocToolkit_throwTag_pre = "@throw " " @exception is also valid
endif
if !exists("g:IldocToolkit_throwTag_post")
  let g:IldocToolkit_throwTag_post = ""
endif
if !exists("g:IldocToolkit_blockHeader")
  let g:IldocToolkit_blockHeader = ""
endif
if !exists("g:IldocToolkit_blockFooter")
  let g:IldocToolkit_blockFooter = ""
endif
if !exists("g:IldocToolkit_licenseTag")
  let g:IldocToolkit_licenseTag = s:licenseTag
endif
if !exists("g:IldocToolkit_fileTag")
  let g:IldocToolkit_fileTag = "Filename:"
endif
if !exists("g:IldocToolkit_authorTag")
  let g:IldocToolkit_authorTag = "Author: "
endif
if !exists("g:IldocToolkit_dateTag")
  let g:IldocToolkit_dateTag = "Date: "
endif
if !exists("g:IldocToolkit_versionTag")
  let g:IldocToolkit_versionTag = "Version: "
endif
if !exists("g:IldocToolkit_undocTag")
  let g:IldocToolkit_undocTag = "DOX_SKIP_BLOCK"
endif
if !exists("g:IldocToolkit_blockTag")
  let g:IldocToolkit_blockTag = "@name "
endif
if !exists("g:IldocToolkit_classTag")
  let g:IldocToolkit_classTag = "@class "
endif

if !exists("g:IldocToolkit_cinoptions")
    let g:IldocToolkit_cinoptions = "c1C1"
endif
if !exists("g:IldocToolkit_startCommentTag ")
  let g:IldocToolkit_startCommentTag = "/** "
  let g:IldocToolkit_startCommentBlock = "/* "
endif
if !exists("g:IldocToolkit_interCommentTag ")
  let g:IldocToolkit_interCommentTag = "; "
endif
if !exists("g:IldocToolkit_interCommentBlock ")
  let g:IldocToolkit_interCommentBlock = "; "
endif
if !exists("g:IldocToolkit_endCommentTag ")
  let g:IldocToolkit_endCommentTag = "*/"
  let g:IldocToolkit_endCommentBlock = "*/"
endif
if exists("g:IldocToolkit_commentType")
  if ( g:IldocToolkit_commentType == "skill" )
    let g:IldocToolkit_startCommentTag  = ";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;\<enter>;;"
    let g:IldocToolkit_interCommentTag  = ";; "
    let g:IldocToolkit_endCommentTag    = ";;\<enter>;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
    let g:IldocToolkit_startCommentBlock = ";; "
    let g:IldocToolkit_interCommentBlock = ";; "
    let g:IldocToolkit_endCommentBlock = ""
  else
    let g:IldocToolkit_commentType = "C"
  endif
else
  let g:IldocToolkit_commentType = "C"
endif
...
"  * \brief foo      --->    /** \brief foo */
"  */
if !exists("g:IldocToolkit_compactOneLineDoc")
  let g:IldocToolkit_compactOneLineDoc = "no"
endif
" /**
"  * \brief foo             /**
"  *                         * \brief foo
...
"  * \return                 */
"  */
if !exists("g:IldocToolkit_compactDoc")
  let g:IldocToolkit_compactDoc = "no"
endif
...
if !exists("g:IldocToolkit_ignoreForReturn")
  let g:IldocToolkit_ignoreForReturn = s:ignoreForReturn[:]
else
  let g:IldocToolkit_ignoreForReturn += s:ignoreForReturn
endif
...
if !exists("g:IldocToolkit_maxFunctionProtoLines")
  let g:IldocToolkit_maxFunctionProtoLines = 10
endif

" Add name of function/class/struct... after pre brief tag if you want
if !exists("g:IldocToolkit_briefTag_className")
  let g:IldocToolkit_briefTag_className = "no"
endif
if !exists("g:IldocToolkit_briefTag_structName")
  let g:IldocToolkit_briefTag_structName = "no"
endif
if !exists("g:IldocToolkit_briefTag_enumName")
  let g:IldocToolkit_briefTag_enumName = "no"
endif
if !exists("g:IldocToolkit_briefTag_namespaceName")
  let g:IldocToolkit_briefTag_namespaceName = "no"
endif
if !exists("g:IldocToolkit_briefTag_funcName")
  let g:IldocToolkit_briefTag_funcName = "no"
endif

" Keep empty line (if any) between comment and function/class/...
if !exists("g:IldocToolkit_keepEmptyLineAfterComment")
  let g:IldocToolkit_keepEmptyLineAfterComment = "no"
endif

" PYTHON specific
"""""""""""""""""
" Remove automatically self parameter from function to avoid its documantation
if !exists("g:IldocToolkit_python_autoRemoveSelfParam")
  let g:IldocToolkit_python_autoRemoveSelfParam = "yes"
endif
" Consider functions as if they always return something (default: yes)
if !exists("g:IldocToolkit_python_autoFunctionReturn")
  let g:IldocToolkit_python_autoFunctionReturn = "yes"
endif


""""""""""""""""""""""""""
" Ildoc license comment
""""""""""""""""""""""""""
function! <SID>IldocLicenseFunc()
  call s:InitializeParameters()

  " Test authorName variable
  if !exists("g:IldocToolkit_authorName")
    let g:IldocToolkit_authorName = input("Enter name of the author (generally yours...) : ")
  endif
  mark d
  let l:date = strftime("%Y")
  exec "normal O".strpart( s:startCommentBlock, 0, 1 )
  exec "normal A".strpart( s:startCommentBlock, 1 ).substitute( g:IldocToolkit_licenseTag, "\<enter>", "\<enter>".s:interCommentBlock, "g" )
  if( s:endCommentBlock != "" )
    exec "normal o".s:endCommentBlock
  endif
  if( g:IldocToolkit_licenseTag == s:licenseTag )
    exec "normal %jA".l:date." - ".g:IldocToolkit_authorName
  endif
  exec "normal `d"
...
" Ildoc license comment
""""""""""""""""""""""""""
function! <SID>IldocAddLicenseFunc()
  exec "normal o".s:interCommentTag."Copyright:"
  exec "normal o".strpart( s:startCommentBlock, 0 ).substitute( g:IldocToolkit_licenseTag, "\<enter>", "\<enter>".s:interCommentBlock, "g" )
endfunction

""""""""""""""""""""""""""
" Ildoc author comment
""""""""""""""""""""""""""
function! <SID>IldocAuthorFunc()
  call s:InitializeParameters()
  ...
  if !exists("g:IldocToolkit_versionString")
    let g:IldocToolkit_versionString = input("Enter version string : ")
  endif
  ...
  exec "normal ".l:insertionMode.s:interCommentTag.g:IldocToolkit_fileTag."\<enter>".s:interCommentTag."  ".l:fileName
  call s:IldocAddLicenseFunc()
  exec "normal o".s:interCommentTag.g:IldocToolkit_briefTag_pre
  mark d
  exec "normal o".s:interCommentTag.g:IldocToolkit_authorTag.g:IldocToolkit_authorName
  exec "normal o".s:interCommentTag.g:IldocToolkit_versionTag.g:IldocToolkit_versionString
  let l:date = strftime("%Y-%m-%d")
  exec "normal o".s:interCommentTag.g:IldocToolkit_dateTag."\<enter>".s:interCommentTag."  ".l:date
  if ( g:IldocToolkit_endCommentTag != "" )
...
""""""""""""""""""""""""""
" Ildoc undocument function
" C/C++ only!
""""""""""""""""""""""""""
function! <SID>IldocUndocumentFunc(blockTag)
  call s:InitializeParameters()
  ...
  while ( search(l:search, 'W') != 0 )
    exec "normal O#ifndef " . g:IldocToolkit_undocTag
    exec "normal j^%"
    if ( g:IldocToolkit_endCommentTag == "" )
      exec "normal o#endif // " . g:IldocToolkit_undocTag 
    else
      exec "normal o#endif /* " . g:IldocToolkit_undocTag . " */"
    endif
  endwhile
...
" IldocBlockFunc
""""""""""""""""""""""""""
function! <SID>IldocBlockFunc()
  call s:InitializeParameters()

  let l:insertionMode = s:StartDocumentationBlock()
  exec "normal ".l:insertionMode.s:interCommentTag.g:IldocToolkit_blockTag
  mark d
...
function! <SID>IldocCommentFunc()
  ...
  if( g:IldocToolkit_keepEmptyLineAfterComment == "no" )
  ...
  while( l:endDocFound == 0 && l:count < g:IldocToolkit_maxFunctionProtoLines )
  ...
  if( ( l:doc.type == "class" && g:IldocToolkit_briefTag_className != "yes" ) || ( l:doc.type == "struct" && g:IldocToolkit_briefTag_structName != "yes" ) || ( l:doc.type == "enum" && g:IldocToolkit_briefTag_enumName != "yes" ) || ( l:doc.type == "namespace" && g:IldocToolkit_briefTag_namespaceName != "yes" ) || ( l:doc.type == "function" && g:IldocToolkit_briefTag_funcName != "yes" ) )
    let l:doc.name = "None"
  ...
  call s:InitializeParameters()
  if( s:CheckFileType() == "python" && l:doc.type == "function" && g:IldocToolkit_python_autoFunctionReturn == "yes" )
    let l:doc.returns = "yes"
  endif

  " Header
  exec "normal `d" 
  if( g:IldocToolkit_blockHeader != "" )
    exec "normal O".strpart( s:startCommentBlock, 0, 1 )
    exec "normal A".strpart( s:startCommentBlock, 1 ).g:IldocToolkit_blockHeader.s:endCommentBlock
    exec "normal `d" 
  endif
 
  " Brief
  if( g:IldocToolkit_compactOneLineDoc =~ "yes" && l:doc.returns != "yes" && len( l:doc.params ) == 0 )
    let s:compactOneLineDoc = "yes"
    exec "normal O".strpart( s:startCommentTag, 0, 1 )
    exec "normal A".strpart( s:startCommentTag, 1 ).g:IldocToolkit_briefTag_pre
  else
    let s:compactOneLineDoc = "no"
    let l:insertionMode = s:StartDocumentationBlock()
    exec "normal ".l:insertionMode.s:interCommentTag.g:IldocToolkit_briefTag_pre
  endif
  if( l:doc.name != "None" )
    exec "normal A".l:doc.name." "
  endif
  exec "normal A".g:IldocToolkit_briefTag_post

  " Mark the line where the cursor will be positionned.
  mark d

  " Arguments/parameters
  if( g:IldocToolkit_compactDoc =~ "yes" )
  ...
  for param in l:doc.templates
    ...
    exec "normal o".s:interCommentTag.g:IldocToolkit_templateParamTag_pre.param.g:IldocToolkit_templateParamTag_post
  endfor
  for param in l:doc.params
    ...
    exec "normal o".s:interCommentTag.g:IldocToolkit_paramTag_pre.param.g:IldocToolkit_paramTag_post
  endfor
  ...
  if( l:doc.returns == "yes" )
    ...
    exec "normal o".s:interCommentTag.g:IldocToolkit_returnTag
  endif
  ...
  if( len( l:doc.throws ) > 0 )
    ...
    for param in l:doc.throws
      ...
      exec "normal o".s:interCommentTag.g:IldocToolkit_throwTag_pre.param.g:IldocToolkit_throwTag_post
    endfor
  endif
  ...
  " Footer
  if ( g:IldocToolkit_blockFooter != "" )
    exec "normal o".strpart( s:startCommentBlock, 0, 1 )
    exec "normal A".strpart( s:startCommentBlock, 1 ).g:IldocToolkit_blockFooter.s:endCommentBlock
  endif
  exec "normal `d"
...
function! s:ParseFunctionParameters( lineBuffer, doc )
  ...
  if( s:CheckFileType() == "cpp" )
    ...
    for ignored in g:IldocToolkit_ignoreForReturn
  ...
  if( s:CheckFileType() == "cpp" )
    ...
    if( g:IldocToolkit_python_autoRemoveSelfParam == "yes" )
...
function! s:InitializeParameters()
  if( s:CheckFileType() == "cpp" )
    let s:startCommentTag   = g:IldocToolkit_startCommentTag
    let s:interCommentTag   = g:IldocToolkit_interCommentTag
    let s:endCommentTag     = g:IldocToolkit_endCommentTag
    let s:startCommentBlock = g:IldocToolkit_startCommentBlock
    let s:interCommentBlock = g:IldocToolkit_interCommentBlock
    let s:endCommentBlock   = g:IldocToolkit_endCommentBlock
  else
  ...
  let &cinoptions        = g:IldocToolkit_cinoptions
...
" Shortcuts...
""""""""""""""""""""""""""
command! -nargs=0 Ildoc :call <SID>IldocCommentFunc()
command! -nargs=0 IldocLic :call <SID>IldocLicenseFunc()
command! -nargs=0 IldocAuthor :call <SID>IldocAuthorFunc()
command! -nargs=1 IldocUndoc :call <SID>IldocUndocumentFunc(<q-args>)
command! -nargs=0 IldocBlock :call <SID>IldocBlockFunc()
